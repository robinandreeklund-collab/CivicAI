...
export default function FactCheckIndicator({ factCheck }) {
  ...
  const priorityColors = {
    ...
    medium: 'text-gray-400 bg-gray-400/10',
    low: 'text-gray-400 bg-civic-gray-400/10',
  };
  ...
  return (
    <div className="space-y-2">
      ...
      <button
        ...
        className="w-full flex items-center justify-between px-3 py-2 rounded-lg bg-civic-gray-500/10 text-gray-300 hover:bg-civic-gray-500/20 transition-all"
      >
