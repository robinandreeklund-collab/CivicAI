        ...
        {steps.map((stepText, index) => {
          ...
          return (
            ...
            >
              ...
              {isCompleted && (
                <div className="flex-shrink-0 w-6 h-6 rounded-full bg-green-500 flex items-center justify-center animate-scale-in">
              ...
              {isActive && (
                <div className="absolute inset-0 pointer-events-none">
                  <div className="absolute inset-0 bg-blue-400/5 rounded animate-ping"></div>
                </div>
              )}
            </div>
          );
