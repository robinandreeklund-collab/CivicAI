...
export default function ToneIndicator({ toneAnalysis }) {
  ...
  const toneColors = {
    formal: 'bg-civic-gray-500/20 text-gray-300 border-civic-gray-500/30',
    informal: 'bg-civic-gray-500/20 text-gray-300 border-civic-gray-500/30',
    technical: 'bg-civic-gray-500/20 text-gray-300 border-purple-500/30',
